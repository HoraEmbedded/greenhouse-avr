"""Generates a Wokwi Automation Scenario for the V2 greenhouse firmware.

The scenario drives DHT22 temperature, DHT22 humidity, the soil potentiometer,
and the water-level float switch through a full hysteresis cycle.
...
def main():
    ...
    scenario = {"name": "V2 automated environmental drift", "version": 1, "steps": steps}
    ...
    print(f"  Suggested --timeout: {int(total_s * 1000) + 5000} ms")
